...
class HaventAccountRowWidget extends StatelessWidget {
  const HaventAccountRowWidget({Key? key, required this.underLineText, required this.text, required this.loginOrRegister}) : super(key: key);
