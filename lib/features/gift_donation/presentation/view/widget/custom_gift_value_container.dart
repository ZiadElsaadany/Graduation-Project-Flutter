...
class CustomGiftValueContainer extends StatelessWidget {
  const CustomGiftValueContainer({Key? key,
    required this.text,
    required this.giftCategoryModel, required this.onTap, required this.index,
   })
      : super(key: key);
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                color: (cubit.itemIndex==index&&cubit.selected==true) ? giftCategoryModel.color! : Colors.transparent,
